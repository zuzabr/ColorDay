...
#include "DA_EmemyAbilities.generated.h"
...
UCLASS()
class COLORDAY_API UDA_EmemyAbilities : public UDataAsset
{
	GENERATED_BODY()
...
private:
	UPROPERTY(EditDefaultsOnly, Category = "StartUpData")
	TArray<TSubclassOf<UColorDayGameplayAbility>> EnemyAbilities;
};
